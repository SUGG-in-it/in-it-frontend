...
const StatusBar = () => {
  ...
  const hadleStatus = (index: number) => {
    ...
    switch (index) {
      case 0:
        router.push({ pathname: '/question/list', query: { status: 'total' } });
        break;
      case 1:
        router.push({ pathname: '/question/list', query: { status: 'completed' } });
        break;
      case 2:
        router.push({ pathname: '/question/list', query: { status: 'doing' } });
        break;
    }
  };
